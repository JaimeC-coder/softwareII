<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('idTipoproducto', $tipoProducto, $producto->idTipoproducto, ['class' => 'form-control' . ($errors->has('idTipoproducto') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un Tipo de producto']) }}
            {!! $errors->first('idTipoproducto', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('idUnidadmedida','Unidad de Medida') }}

            {!! Form::select('idUnidadmedida', $unidadMedida, $producto->idUnidadmedida, ['class' => 'form-control' . ($errors->has('idUnidadmedida') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione Su inidad de venta']) !!}
